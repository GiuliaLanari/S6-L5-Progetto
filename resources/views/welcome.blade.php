...
@section("content")
<h1 class="my-5 text-center display-5 text-info-emphasis">Welcome to Adventures!</h1>
  ...
  <div class="col-10 mx-0 mb-5">
     ...
     <div class="card bg-welcome">
       <div class="card-body">
        ...
        <p class="card-text">Welcome to Adventures, the reference point for those who love adventure and nature! We are a team of outdoor enthusiasts and explorers dedicated to creating unique and memorable experiences. For years we have been organizing activities and excursions for all those who wish to discover the hidden treasures of our beautiful land.</p>
    ...
    <div class="col-12 mt-5">
      <div class="row ">
        <div class="col-12 col-md-4 img-welcome mt-4">
